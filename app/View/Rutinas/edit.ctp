...
<?php echo $this->Form->create('Rutina'); ?>
	<fieldset>
		<legend><?php echo __('Edit Rutina'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Rutina.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Rutina.id'))); ?></li>
